...
// アフィン変換行列
Matrix4x4 Rendering::MakeAfineMatrix(
	...
	Matrix4x4 rxyz = Calculation::Multiply(rx, Calculation::Multiply(ry, rz));
	Matrix4x4 result = Calculation::Multiply(Calculation::Multiply(s, rxyz), t);
